            ...
            <table class="w-full border border-collapse border-gray-400">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border p-2 border-gray-400 align-top text-center">
                            {{ money($record->cost, $record->currency, true)->formatWithoutZeroes() }}
                            <div>&nbsp;</div>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr class="bg-gray-200">
                        ...
                        <td class="border p-2 border-gray-400 font-bold text-center">{{ money($record->cost, $record->currency, true)->formatWithoutZeroes() }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
