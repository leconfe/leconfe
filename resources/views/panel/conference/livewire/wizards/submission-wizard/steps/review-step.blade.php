                    ...
                    <div
                        ...
                        <div class="flex-1 space-y-1 filament-forms-section-header">
                            <h3 class="flex flex-row items-center text-xl font-bold tracking-tight pointer-events-none">
                                {{ __('translation.submissions.reviewStepH3') }}
                            </h3>
                            <div class="space-y-4">
                                <p class="text-base text-gray-500">
                                   {{ __('translation.submissions.reviewStepBeforeSubmittingPleaseCheck') }}
                                </p>
                                <p class="text-base text-gray-500">
                                    {{ __('translation.submissions.reviewStepAfterYouSubmit') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 filament-forms-section-content-wrapper">
                        @error('errors')
                            <div class="flex p-4 mb-4 text-sm border text-danger-800 border-danger-300 rounded-xl bg-danger-50 dark:bg-gray-800 dark:text-danger-400 dark:border-danger-800"
                                ...
                                <span class="sr-only"> {{ __('translation.submissions.reviewStepInfo') }}</span>
                                <div>
                                    {{ $message }}
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex ml-auto">
                                <x-filament::button class="ml-auto" :outlined="true" size="sm" x-on:click="step = 'detail'">
                                    {{ __('translation.submissions.reviewStepEditSubmission') }}
                                </x-filament::button>
                            </div>
                            <ul
                                ...
                                <li
                                    ...
                                    <div class="text-base font-bold">{{ __('translation.submissions.reviewStepHeading') }}</div>
                                </li>
                                <li class="w-full p-4 border-b border-gray-200 sm:px-6 dark:border-gray-800">
                                    <div class="font-medium">{{ __('translation.submissions.reviewStepTitle') }}</div>
                                ...
                                <li class="w-full p-4 space-y-2 border-b border-gray-200 sm:px-6 dark:border-gray-800">
                                    <div class="font-medium">{{ __('translation.submissions.reviewStepKeywords') }}</div>
                                    <div class="flex flex-wrap items-center gap-1 text-gray-700">
                                        ...
                                        @empty
                                         {{ __('translation.submissions.reviewStepEmpty') }}
                                        @endforelse
                                    </div>
                                </li>
                                <li class="w-full p-4 border-gray-800 sm:px-6 dark:border-gray-800">
                                    <div class="font-medium"> {{ __('translation.submissions.reviewStepAbstract') }}</div>
                        ...
                        <div class="space-y-4">
                            <div class="flex ml-auto">
                                <x-filament::button class="ml-auto" :outlined="true" size="sm" x-on:click="step = 'upload-files'">
                                    {{ __('translation.submissions.reviewStepEditFiles') }}
                                </x-filament::button>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex ml-auto">
                                <x-filament::button class="ml-auto" :outlined="true" size="sm"  x-on:click="step = 'authors'">
                                    {{ __('translation.submissions.reviewStepEditContributors') }}
                                </x-filament::button>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex ml-auto">
                                <x-filament::button class="ml-auto" :outlined="true" size="sm"  x-on:click="step = 'presenters'">
                                    {{ __('translation.submissions.reviewStepEditPresenters') }}
                                </x-filament::button>
                            </div>
