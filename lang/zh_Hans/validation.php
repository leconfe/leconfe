...
return [
    ...
    'doesnt_end_with' => ':attribute 字段结尾不能是以下值之一：:values。',
    'doesnt_start_with' => ':attribute 字段开头不能是以下值之一：:values。',
    'email' => ':attribute 字段必须是一个有效的电子邮件地址。',
    'ends_with' => ':attribute 字段结尾必须是以下值之一：:values。',
    ...
    'lt' => [
        ...
        'string' => ':attribute 字段的字符数必须小于 :value。',
    ],
    'lte' => [
        'array' => ':attribute 字段的项目数不得超过 :value。',
        'file' => ':attribute 字段必须小于或等于 :value 千字节。',
        'numeric' => ':attribute 字段必须小于或等于 :value。',
        'string' => ':attribute 字段的字符数必须小于或等于 :value。',
    ],
    'mac_address' => ':attribute 字段必须是有效的 MAC 地址。',
    'max' => [
        'array' => ':attribute 字段的项目数不得超过 :max。',
        'file' => ':attribute 字段不得超过 :max 千字节。',
        'numeric' => ':attribute 字段不得超过 :max。',
        'string' => ':attribute 字段的字符数不得超过 :max。',
    ],
    'max_digits' => ':attribute 字段的数字不能超过 :max 位。',
    ...
    'missing' => ':attribute 字段必须为空。',
    'missing_if' => '当 :other 为 :value 时，:attribute 字段必须为空。',
    'missing_unless' => '除非 :other 为 :value，否则 :attribute 字段必须为空。',
    'missing_with' => '当 :values 存在时，:attribute 字段必须为空。',
    'missing_with_all' => '当 :values 存在时，:attribute 字段必须为空。',
    ...
    'password' => [
        ...
        'uncompromised' => '提供的 :attribute 已出现在数据泄露中。请选择一个不同的 :attribute。',
    ],
    'phone' => ':attribute 字段必须是一个有效的数字。',
    ...
    'weight_over' => '请确保总重量不超过100%。当前为:attribute%。',
    'custom' => [
        'attribute-name' => [
            'rule-name' => '自定义消息',
        ],
